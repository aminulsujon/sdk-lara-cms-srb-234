...
?>
        ...
        <div class="container">
            <div class="trending-main">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        @if(!empty($websettings['cms_ads_status']))
                            <div class="mb-4">
                                @include('blog.ads.300x250',['width'=>300,'height'=>250,'position'=>'Category R1','text'=>'Advertisment 300x250'])
                            </div> 
                        @endif
                ...
                <div class="container mt-4">
                    @foreach($tag->contents->skip(8)->take(30) as $content)
    ...
    <!--Start pagination -->
    <div class="d-none pagination-area pb-45 text-center pt-4">
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                    <div class="single-wrap d-flex justify-content-center">
                        <nav aria-label="Page navigation example">
                            ...
                            <li class="page-item"><a class="page-link" href="#"><span class="flaticon-arrow roted"></span></a></li>
                                <li class="page-item active"><a class="page-link" href="#">আরও সংবাদ</a></li>
