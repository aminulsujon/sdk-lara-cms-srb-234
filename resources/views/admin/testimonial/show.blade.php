    ...
    <div class="col-md-6">
        <div class="main-card mb-3 card">
            @include('admin/card_head',[
                ...
                'info'=>'testimonial details goes here...',
                'links'=>[
        ...
        <div class="card-body">
        <form id="blog-show" action="{{URL::to('admin/testimonial/'.$content->id)}}"  method="post" enctype="multipart/form-data">
        ...
        <div class="position-relative form-group">
            @include('admin.form_ckeditor',['label'=>'Testimonial Description','name'=>'description','value'=>  $content->description])
        </div>
        <div class="mb-2">
