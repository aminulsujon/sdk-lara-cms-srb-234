...
<div class="col-lg-12">
    ...
    <div class="main-card mb-3 card">
        @include('admin/card_head',[
            'title'=>$contenttype.' management',
            'info'=>'Manage '.$contenttype.' from this page, image size should be 900x600px',
            'links'=>[
                0=>['text'=>'Create new','link'=>'/admin/content/create?type='.$contenttype],
                ]  
            ])
    <div class="card-body">
    ...
    <tr>
        ...
        <td style="width:150px">
            <a href="{{URL::to('admin/content/'.$content->id.'/edit')}}" title="Edit" style="float: left; margin-left: 10px; margin-right: 10px">
                <button type="submit" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i>
                    Edit
                </button>
            </a>   
            <form action="{{URL::to('admin/content/'.$content->id)}}" method="post">
                @csrf
                @method('DELETE')
