...
<div class="col-md-12">
    <div class="main-card mb-3 card">
        @include('admin/card_head',[
            ...
            'links'=>[
                0=>['text'=>$content->content_type.' Management','link'=>'/admin/content?type='.$content->content_type],
                1=>['text'=>'Create New '.$content->content_type,'link'=>'/admin/content/create?type='.$content->content_type],
                ]  
            ])
    <div class="card-body">
    <form id="myForm" action="{{URL::to('admin/content/'.$content->id)}}"  method="post" enctype="multipart/form-data">    
    @csrf
    @method('PATCH')
