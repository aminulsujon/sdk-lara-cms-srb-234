...
<div class="border p-2 mb-2 bg-light">
    ...
    <div class="row">
        ...
        <div class="col-md-8" >
            <input type="hidden" name="image_remove_id" id="image_remove_id">
            <div id="image_remove_warning" style="display:none" class="text-danger">
                <span class="text-warning"><b>Warning:</b></span> This image will be removed after submit this form.
                <a onclick="cancelImageRemoval()" href="javascript:void(0);" class="btn btn-danger">Cancel</a>
            </div>
            <a id="image_remove_button" onclick="setImageRemoval({{$file['id']}})" href="javascript:void(0);" class="btn btn-danger">Remove Image</a>
