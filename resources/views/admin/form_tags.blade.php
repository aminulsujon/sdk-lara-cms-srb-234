    ...
    <div class="">
      @if(!empty($content->tags))
          ...
          foreach($content->tags as $otag){
            if(!empty($otag->tag_type) && $otag->tag_type == 4){
              echo "<div><input type='checkbox' checked='checked' name='tags[]' value='".$otag->id."' id='hidden-tag-".$otag->id."'><span id='hidden-tag-show".$otag->id."'>".$otag->title."</span></div>";
            }
          }
          @endphp
        @endif
    ...
    @if(!empty($content->tags))
        ...
        foreach($content->tags as $otag){
          if(!empty($otag->tagtype) && $otag->tagtype == 4){
            echo "<input type='checkbox' checked='checked' name='tags[]' value='".$otag."' id='hidden-tag-".$otag->id."'><span id='hidden-tag-show".$otag->id."'>".$otag->title."</span>";
          }
        }
        @endphp
       @endif
