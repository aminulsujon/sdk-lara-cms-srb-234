...
<div class="col-lg-12">
    ...
    <div class="main-card mb-3 card">
        @include('admin/card_head',[
            'title'=>'Case Studies',
            'info'=>'Case study management',
            'links'=>[
                0=>['text'=>'Create works','link'=>'/admin/work/create'],
                ]  
            ])
    <div class="card-body">
    ...
    <tr>
        ...
        <td style="width:150px">
            <a href="{{URL::to('admin/work/'.$content->id.'/edit')}}" title="Edit" style="float: left; margin-left: 10px; margin-right: 10px">
...
Edit
            ...
            <form action="{{URL::to('admin/work/'.$content->id)}}" method="post">
                @csrf
                @method('DELETE')
