    ...
    <div class="col-md-12">
        <div class="main-card mb-3 card">
            @include('admin/card_head',[
                ...
                'info'=>'Create your case study from this page, image size should be 900x600px',
                'links'=>[
            ...
            <div class="card-body">
                <form id="myForm" name="myForm" class="" action="{{URL::to('admin/work')}}"  method="post" enctype="multipart/form-data">
                    @csrf
