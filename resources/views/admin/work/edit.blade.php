...
<div class="col-md-12">
    <div class="main-card mb-3 card">
        @include('admin/card_head',[
            'title'=>'Edit work',
            'info'=>'Edit your work from this page, image size should be 900x600px',
            'links'=>[
                0=>['text'=>'Work Management','link'=>'/admin/work'],
                1=>['text'=>'Create New Work','link'=>'/admin/work/create'],
                ]  
            ])
    <div class="card-body">
    <form id="myForm" action="{{URL::to('admin/work/'.$content->id)}}"  method="post" enctype="multipart/form-data">    
    @csrf
    @method('PATCH')
