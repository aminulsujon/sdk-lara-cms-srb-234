...
<div class="col-md-12">
    <div class="main-card mb-3 card">
        @include('admin/card_head',[
            'title'=>'Edit page',
            'info'=>'Edit your pages from this page, image size should be 900x600px',
            'links'=>[
                0=>['text'=>'Page Management','link'=>'/admin/page'],
                1=>['text'=>'Create New page','link'=>'/admin/page/create'],
                ]  
            ])
    <div class="card-body">
    <form id="myForm" action="{{URL::to('admin/page/'.$content->id)}}"  method="post" enctype="multipart/form-data">    
    @csrf
    @method('PATCH')
