...
class WorkController extends Controller
{
    ...
    public function comments()
    {
        ...
        // dd($contents);
        return view('admin.work.index',compact('contents'));
    }
    ...
    {
        $contents = Content::where('content_type' , 'work' )->with('upload')->orderBy('id','desc')->paginate();
        // $contents = Content::where('content_type' , 'work' )->with('upload','Tag','Comment')->orderBy('id','desc')->paginate();
        // dd($contents);
        return view('admin.work.index',compact('contents'));
    }
    ...
    public function create()    
    {
        ...
        // dd($tags_category );
        return view('admin.work.create',compact('tags','tags_category'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $result = (new LandingController)->generateLanding('work',$statusCode,$request->slug);
        if($result == 2){ 
            if($content->save()){
    ...
    public function show(string $id)
    {
        ...
        // dd($content);
        return view('admin.work.show',compact('content','tags','tags_category'));
    }
    ...
    public function edit(string $id)
    {
        ...
        // dd($content);
        return view('admin.work.edit',compact('content'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        if($content->save()){
            if($request->slug != $request->oldslug){
                $result = (new LandingController)->generateLanding('work',$statusCode,$request->slug);
                $result_new = (new LandingController)->addNextLanding('work',301,$request->oldslug,$request->slug);
            }
            else{
                $result = (new LandingController)->updateLanding('work',$statusCode,$request->slug);
            }
