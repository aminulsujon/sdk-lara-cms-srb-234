...
class ContentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // dd($contenttype);
        $contents = Content::where('content_type' , $contenttype )->with('upload')->orderBy('id','desc')->paginate();
        // $contents = Content::where('content_type' , 'home' )->with('upload','Tag','Comment')->orderBy('id','desc')->paginate();
        // dd($contents);
        return view('admin.content.index',compact('contents','contenttype'));
    }
    ...
    public function create(Request $request)    
    {
        ...
        // dd($tags_category );
        return view('admin.content.create',compact('tags','tags_category','contenttype'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $result = (new LandingController)->generateLanding('home',$statusCode,$request->slug);
        if($result == 2){ 
            if($content->save()){
                ...
                return redirect('admin/content?type='.$request->contenttype);
            }
            return redirect('admin/content?type='.$request->contenttype);
        }
        return redirect('admin/content?type='.$request->contenttype);
    ...
    public function show(string $id)
    {
        ...
        // dd($content);
        return view('admin.content.show',compact('content','tags','tags_category'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        if($content->save()){
            if($request->slug != $request->oldslug){
                $result = (new LandingController)->generateLanding('home',$statusCode,$request->slug);
                $result_new = (new LandingController)->addNextLanding('home',301,$request->oldslug,$request->slug);
            }
            else{
                $result = (new LandingController)->updateLanding('home',$statusCode,$request->slug);
            }
            ...
            return redirect('admin/content?type='.$content->content_type);
        }
        return redirect('admin/content?type='.$content->content_type);
    }
